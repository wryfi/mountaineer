"""
Django settings for environty project.
...
from environty.core.utils import settings as utils
...
WSGI_APPLICATION = 'environty.core.wsgi.application'
...
MEDIA_ROOT = os.path.join(HOME, 'var', 'environty', 'media')
STATIC_ROOT = os.path.join(HOME, 'share', 'environty', 'static')
...
LOGGING = {
    ...
    'handlers': {
      'file': {
          ...
          'filename': os.path.join(LOG_DIR, 'environty.log'),
